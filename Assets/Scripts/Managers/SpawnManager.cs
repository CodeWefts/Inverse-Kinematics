...
public class SpawnManager : MonoBehaviour
{
    ...
    [SerializeField] private bool IsRawModel = false;
    ...
    private void SpawnBones()
    {
        ...
        for (int j = 0; j < segments; j++)
        {
            ...
            newJoint.GetComponent<JointManager>().clampMin = new Vector3(-180f, -180f, -180f);
            newJoint.GetComponent<JointManager>().clampMax = new Vector3(180f, 180f, 180f);
